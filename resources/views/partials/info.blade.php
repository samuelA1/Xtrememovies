    ...
    <div class="container">
        ...
        <div class="row about-cols">
            ...
            <div class="col-md-6 wow wow-image fadeInUp">
                        <img src="{{asset('img/popcorn.jpg')}}" alt="" class="img-fluid">
            </div>

            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <h2 class="title">Exclusive Teen Deal</h2>
                <p>Teens, give your movie the blockbuster refreshment it deserves. #cupgrade your weekend with this $5 Coke® & popcorn deal. Tax not included.</p>
                <div class="alert alert-success" role="alert">
                    Get these deals at your respective theatres for $3 or less.
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row about-cols">
            ...
            <div class="col-lg-4 col-md-6 wow wow-image fadeInUp" data-wow-delay="0.1s">
                ...
                <a href="{{url('gift-cards')}}" class="btn btn-danger">Buy Now</a>
            </div>

            <div class="col-md-6 col-lg-5 col-xl-6  wow wow-image  fadeInUp">
                <img style="width: 70%" src="{{asset('img/card.png')}}" alt="" class="img-fluid">
            </div>
        </div>
